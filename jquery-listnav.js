	...
	$.fn.listnav = function (options) {
		...
		return this.each(function () {
			...
			function createSearch() {
				var tpl = opts.searchTemplate;
				var urlvar = _helper_getParameterByName(opts.searchVal);
			...
			function _helper_getParameterByName(name, url) {
